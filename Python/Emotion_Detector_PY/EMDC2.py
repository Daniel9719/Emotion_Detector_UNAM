...
def train(features_csv,targets_csv):    
    ...
    list_LDF=[list_W_1,list_W_2,list_W_3,list_W_4]
    ...
    return list_SFFS, list_LDF, list_LDA_mk,list_LDA_pik,list_LDA_S_inv
...
list_SFFS, list_LDF, list_LDA_mk,list_LDA_pik,list_LDA_S_inv=train_and_test(features_csv,targets_csv)